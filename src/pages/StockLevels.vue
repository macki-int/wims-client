            ...
            <div style="min-height: 800px">
              <q-card-section>
                <div class="text-h6">
                  {{ productType.name }}
                  <q-checkbox
                    @input="getProductsAndQuantityByProductTypeId"
                    class="text-body2 q-pl-xl"
                    size="xs"
                    color="grey"
                    v-model="showZeroValue"
                    label="Pokaż stany zerowe"
                  ></q-checkbox>
                  <q-checkbox
                    @input="getProductsAndQuantityByProductTypeId"
                    ...
                    size="xs"
                    color="grey"
                    v-model="showActiveProduct"
                    label="Pokaż nieaktywne produkty"
                  ></q-checkbox>
                  <q-badge class="float-right" outline color="primary"
                    >stan na {{ maxUpdateDate[0] }}</q-badge
                  >
                </div>
              </q-card-section>
            ...
            <div style="min-height: 800px">
              <q-card-section>
                <div class="q-pa-md" style="max-width: 470px">
                  <q-form
                    @submit="onSubmitInwentory"
                    @reset="onNewInventory"
                    class="q-gutter-md"
                  >
                    <div>
                      <q-input
                    ...
                    <div>
                      <q-btn
                        v-show="showNewInventoryButton"
                        flat
                        label="Nowy asortyment"
                        type="reset"
                        color="primary"
                      />
                      <q-btn
                    ...
                    <q-badge
                      v-if="newInventoryIndicator"
                      outline
                      color="primary"
                      align="middle"
                      label="Dodajesz nowy asortyment"
                    />
                    <q-badge
                      v-if="!newInventoryIndicator && !disabled"
                      outline
                      color="primary"
                      align="middle"
                      label="Edytujesz istniejący asortyment"
                    />
