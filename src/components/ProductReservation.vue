     ...
     <q-table flat :data='reservations' :columns='columns' row-key='name' v-bind:request='getReservationsByInventoryId'>
        <q-tr slot='body' slot-scope='props' :props='props'>
            ...
            <q-td>
                ...
                <q-btn size="xs" dense color="negative" icon="clear" class="q-mr-xs" v-on:click.native='onClick(props.row)' />
                    ...
                    <q-card>
                        ...
                        <q-card-section class='row items-center bg-negative'>
                            ...
                            <span class='q-ml-sm text-white'>
                                ...
                                <br />
                                <strong>{{ props.row.user.nick }}</strong> (ilość: {{ props.row.quantity }})?
                            </span>
                        </q-card-section>
    ...
    <q-dialog v-model='save' persistent>
        <q-card style='min-width: 350px'>
            ...
            <q-card-section class='q-pt-none'>
                ...
                <!-- <q-input dense v-model.trim='newReservationStopDate' label='data' /> -->
                <q-input dense v-model.trim='newReservationDescription' label='Uwagi' type='textarea' autogrow />
            </q-card-section>
        ...
        filterUsers(val, update, abort) {
            update(() => {
                ...
                this.filteredUsers = this.users
                    .filter(v => `${v.nick}`.indexOf(needle) > -1)
            })
        },
