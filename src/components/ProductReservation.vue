<template>
  <div>
    <q-table
      ...
      :columns="columns"
      row-key="name"
      v-bind:request="getReservationsByInventoryId"
    >
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td>
          ...
          <q-btn
            ...
            icon="clear"
            class="q-mr-xs"
            v-on:click.native="onClick(props.row)"
          />
    ...
    <q-dialog v-model="save" persistent>
      <q-card style="min-width: 350px">
        ...
        <q-card-section class="q-pt-none">
          ...
          <q-input
            dense
            v-model.trim="newReservationQuantity"
            label="ilość"
            type="number"
            :decimals="2"
          ...
          <q-input
            dense
            v-model="newReservationStopDate"
          ...
          <q-input
            dense
            v-model.trim="newReservationDescription"
            label="Uwagi"
            type="textarea"
            autogrow
          />
